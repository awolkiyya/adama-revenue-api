...
return new class extends Migration
{
    ...
    {
        Schema::create('service_capture_values', function (Blueprint $table) {
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            | The selected revenue service inside the capturable
            | parent (Assessment or FieldCollection).
            |
            | Example:
            |
            | Assessment / FieldCollection
            |   └── Property Tax Service   (service_captures)
            |           └── service_capture_values
            |
            */

            $table->foreignUuid('service_capture_id')
                ->constrained('service_captures')
                ->cascadeOnDelete();
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            | Historical label displayed to the officer/collector.
            |
            | Example:
            |
            | Land Area
            ...
            */
            ...
            | value inside one service capture.
            |
            */
    ...
    {
        Schema::dropIfExists('service_capture_values');
    }
};